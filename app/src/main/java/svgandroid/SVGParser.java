...
public class SVGParser {
     ...
     */
    public  SVG getSVGFromInputStream(InputStream svgData) throws SVGParseException {
        return parse(svgData, 0, 0, false);
    }

    public SVGHandler getSVGHandler(){
        return handler;
    }
     ...
     * @throws SVGParseException if there is an error while parsing.
     */
    public SVG getSVGFromString(String svgData) throws SVGParseException {
        return parse(new ByteArrayInputStream(svgData.getBytes()), 0, 0, false);
    }
     ...
     * @throws SVGParseException if there is an error while parsing.
     */
    public SVG getSVGFromResource(Resources resources, int resId) throws SVGParseException {
        return parse(resources.openRawResource(resId), 0, 0, false);
    }
     ...
     */
    public SVG getSVGFromAsset(AssetManager assetMngr, String svgPath) throws SVGParseException, IOException {
     ...
     * @throws SVGParseException if there is an error while parsing.
     */
    public SVG getSVGFromInputStream(InputStream svgData, int searchColor, int replaceColor) throws SVGParseException {
        return parse(svgData, searchColor, replaceColor, false);
    }
     ...
     * @throws SVGParseException if there is an error while parsing.
     */
    public SVG getSVGFromString(String svgData, int searchColor, int replaceColor) throws SVGParseException {
        return parse(new ByteArrayInputStream(svgData.getBytes()), searchColor, replaceColor, false);
    }
     ...
     * @throws SVGParseException if there is an error while parsing.
     */
    public SVG getSVGFromResource(Resources resources, int resId, int searchColor, int replaceColor) throws SVGParseException {
        return parse(resources.openRawResource(resId), searchColor, replaceColor, false);
    }
     ...
     * @throws IOException       if there was a problem reading the file.
     */
    public SVG getSVGFromAsset(AssetManager assetMngr, String svgPath, int searchColor, int replaceColor) throws SVGParseException, IOException {
        InputStream inputStream = assetMngr.open(svgPath);
...
//        Util.debug("Parsing SVG...");
        try {
            ...
            handler = new SVGHandler(picture);
...
//        Util.debug("Parsing complete in " + (System.currentTimeMillis() - start) + " millis.");
           ...
           // throw new SVGParseException("message");
        }
        return null;
    }
